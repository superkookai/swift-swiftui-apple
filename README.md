...
- **KobayashiMaru** - Refactoring SwiftUI projects
[KobayashiMaru](https://github.com/superkookai/KobayashiMaru)

- **UnwrapLive2026** - `Canvas`, `Timeline`, `TextRenderer`, `ScrollView Transition`
[UnwrapLive26](https://github.com/superkookai/UnwrapLive26)

- **Chatterbox** - SwiftUI Chat app with `OpenAI`
[ChatterBox](https://github.com/superkookai/ChatterBox)
...
- **NetworkExample** - HWS `NetworkMonitor` and `URLSession configuration` (can set requestCachePolicy and others) [NetworkExample](https://github.com/superkookai/NetworkExample)
...
- **NetworkingProject** - [Karen] Networking hiding complexity with Protocol and Struct (Endpoint, APIClient,Service,ViewModel), pagination(load more), search, sort, structure task [NetworkingProject](https://github.com/superkookai/NetworkingProject)
...
- **KNetworking** `Swift Package Library` [by myself] for `Networking with REST API` Using Endpoint, URLRequest, URLSession, Generic, Decoding/Encoding, GET/POST/PUT/DELETE [KNetworking](https://github.com/superkookai/KNetworking)
